      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-4">
              <a href="/anuncie" className="text-[#a8a8a8] hover:text-white text-sm transition-colors">Anuncie Aqui</a>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[#a8a8a8] text-sm">(11) 98555-0123</span>
              </div>
              <div className="flex items-center gap-4">
                <Mail size={18} className="text-[#D69869]" strokeWidth={2} />
                <span className="text-[#a8a8a8] text-sm">contato@menuzonanorte.com.br</span>
              </div>
              <div className="flex items-center gap-4">
