...
const styles: FilterOption[] = [
  { label: 'Todas as Massas', value: 'todos' },
...
const neighborhoods: FilterOption[] = [
  ...
  { label: 'Vila Guilherme', value: 'vila-guilherme' },
]

type PizzaFilterBarProps = {
...
export default function PizzaFilterBar({ isIfoodActive, setIsIfoodActive, activeSort, setActiveSort, searchQuery, setSearchQuery }: PizzaFilterBarProps) {
