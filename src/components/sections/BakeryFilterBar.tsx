...
const neighborhoods: FilterOption[] = [
  ...
  { label: 'Vila Pauliceia', value: 'vila-pauliceia' },
  { label: 'Jardim São Paulo', value: 'jardim-sao-paulo' },
]

type BakeryFilterBarProps = {
...
export default function BakeryFilterBar({ isIfoodActive, setIsIfoodActive, activeSort, setActiveSort, searchQuery, setSearchQuery }: BakeryFilterBarProps) {
