...
export default async function NovaCategoriaBlogPage({
  searchParams,
}: {
  ...
  return (
    <section className="max-w-3xl">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-serif">Nova Categoria</h2>
          <p className="text-sm text-on-surface/70 mt-1">Crie uma nova categoria para o blog.</p>
        </div>
      </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                id="slug"
                name="slug"
                placeholder="Ex: receitas-praticas (gerado automaticamente se vazio)"
                className="w-full rounded-xl border border-outline px-4 py-2.5 outline-none focus:border-primary"
              />
